...
from .views import ListingCreateView, ListingListView, ListingDetailView, ListingImageUploadView
...
urlpatterns = [
    ...
    path('api/create/', ListingCreateView.as_view(), name='listing-create'),  # Create a new listing
